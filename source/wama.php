...
if ($answer == "deviantart") {
mysql_query(" UPDATE  member SET url = 'zeroeightfoureightyeightfive.php'
...
mysql_query( "INSERT INTO rank (username, url,userdatetime) 
	VALUE ( '$username','zeroeightfoureightyeightfive.php',NOW() )   ") 
or die('Unable to update members URL: ' . mysql_error());
Header("Location: zeroeightfoureightyeightfive.php");
}
else {
Header("Location: traps.php");
}
