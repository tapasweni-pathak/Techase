...
if ($answer == "mandymoore") {
mysql_query(" UPDATE  member SET url = 'wiuendncvsdjs.php'
...
mysql_query( "INSERT INTO rank (username, url,userdatetime) 
	VALUE ( '$username','wiuendncvsdjs.php',NOW() )   ") 
or die('Unable to update members URL: ' . mysql_error());
Header("Location: wiuendncvsdjs.php");
}
else {
Header("Location: tiwjdxcxzkljc.php");
}
