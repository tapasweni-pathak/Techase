...
if ($answer == "jeromeleonjerrybruckheimer") {
mysql_query(" UPDATE  member SET url = 'dhnyawaadhappysendings.php'
...
mysql_query( "INSERT INTO rank (username, url,userdatetime) 
	VALUE ( '$username','dhnyawaadhappysendings.php',NOW() )   ") 
or die('Unable to update members URL: ' . mysql_error());
Header("Location: dhnyawaadhappysendings.php");
}
else {
Header("Location:uwdyuchdvhijccl.php");
}
