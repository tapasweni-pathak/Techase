...
if ($answer == "whatthef**k") {
mysql_query(" UPDATE  member SET url = 'jdhfjkshurgvcnbvn.php'
...
mysql_query( "INSERT INTO rank (username, url,userdatetime) 
	VALUE ( '$username','jdhfjkshurgvcnbvn.php',NOW() )   ") 
or die('Unable to update members URL: ' . mysql_error());
Header("Location: jdhfjkshurgvcnbvn.php");
}
else {
Header("Location: hddsljdjdj.php");
}
